...
Namespace DevExpress.CRUD.View
    ...
    Public Class GridControlCRUDAsyncBehavior
        ...
        Public Shared ReadOnly OnCreateCommandProperty As DependencyProperty = DependencyProperty.Register("OnCreateCommand", GetType(AsyncCommand(Of Object)), GetType(GridControlCRUDAsyncBehavior), New PropertyMetadata(CType(Nothing, PropertyChangedCallback)))
        ...
        Public Shared ReadOnly OnUpdateCommandProperty As DependencyProperty = DependencyProperty.Register("OnUpdateCommand", GetType(AsyncCommand(Of Object)), GetType(GridControlCRUDAsyncBehavior), New PropertyMetadata(CType(Nothing, PropertyChangedCallback)))
        ...
        Public Shared ReadOnly OnDeleteCommandProperty As DependencyProperty = DependencyProperty.Register("OnDeleteCommand", GetType(ICommand), GetType(GridControlCRUDAsyncBehavior), New PropertyMetadata(CType(Nothing, PropertyChangedCallback)))
        ...
        Public Shared ReadOnly OnRefreshCommandProperty As DependencyProperty = DependencyProperty.Register("OnRefreshCommand", GetType(AsyncCommand), GetType(GridControlCRUDAsyncBehavior), New PropertyMetadata(CType(Nothing, PropertyChangedCallback)))
        ...
        Private Function CanRefresh() As Boolean
            Return OnRefreshCommand IsNot Nothing AndAlso Not IsEditingRowState() AndAlso Not OnRefreshCommand.IsExecuting AndAlso (View?.Grid.ItemsSource IsNot Nothing OrElse Not Equals(NoRecordsErrorMessage, Nothing))
        End Function
